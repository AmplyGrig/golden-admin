  ...
  <v-container
      ...
      >
        <v-col
         ...
         <v-col
            ...
            md="6"
          >
             <v-btn rounded outlined large block color="#FFC700" dark>Создать аккаунт</v-btn>
          </v-col>
          <v-col
            cols="12"
            md="3"
      ...
      >
         <v-col
            ...
            md="5"
          >
            <p class="cond">Нажимая кнопку “Создать аккаунт”, Вы соглашаетесь с <a href="#1">Политикой конфиденциальности</a></p>
          </v-col>
...
.page-title{
  font-family: Qanelas Regular Thin!important;
  font-style: normal;
  font-weight: bold;
  font-size: 34px;
  line-height: 42px;
